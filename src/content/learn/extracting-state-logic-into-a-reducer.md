...
한 컴포넌트에서 상태 업데이트가 여러 이벤트 핸들러로 분산되어 있는 경우가 있습니다. 이 경우 컴포넌트를 관리하기 부담스럽게 만들 수 있습니다. 그래서 이 문제를 해결하기 위해 상태를 업데이트하는 모든 로직을 *reducer*를 사용해 컴포넌트 외부로 단일 함수로 통합해 관리할 수 있습니다.
