...
React의 기술 거버넌스는 항상 React 파운데이션 이사회와 독립적으로 유지될 것입니다. 즉, React의 기술적 방향성은 계속해서 React에 기여하고 유지 보수를하는 사람들이 설정하게 됩니다. 이 구조를 결정하기 위해 임시 리더십 위원회를 구성했습니다. 향후 몇 달 안에 업데이트를 공유할 예정입니다.
