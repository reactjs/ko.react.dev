...
React 컴포넌트는 다른 컴포넌트와 통신할 때 **props**를 사용합니다. 모든 부모 컴포넌트는 자식 컴포넌트에게 그들의 props를 전달할 수 있습니다. props는 사용자에게 html 속성을 사용하게 할 뿐만 아니라, 캑체, 배열 그리고 함수를 포함하여 자바스크립트 value값도 함께 사용하게 합니다.
