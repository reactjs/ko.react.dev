...
1. A clone of the [ko.reactjs.org repo](https://github.com/reactjs/ko.reactjs.org) on your local machine
...
1. Go to the [reactjs.org repo](https://github.com/reactjs/ko.reactjs.org) and you should see recently pushed branches.
